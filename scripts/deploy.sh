...
# --- 画面 ---
for f in index.php app.php order.php orders.php download.php register.php sellers.php admin.php payout.php sitemap.php; do
  upload "public/$f" "$f"
done

# --- 部品 ---
for f in kapp_boot.php kapp_lib.php kapp_ui.php kapp_invoice.php kapp_payout.php kapp_config.php; do
  upload "public/$f" "$f"
done
